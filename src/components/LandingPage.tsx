      ...
      <header className="bg-white shadow-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">          <div className="flex flex-wrap justify-between items-center h-auto min-h-[4rem] gap-2">            <div className="flex items-center min-w-0">
            ...
            <button
              ...
              className="bg-bradesco-red text-white px-4 py-2 rounded-lg hover:bg-primary-hover transition-colors font-semibold w-full md:w-auto text-sm sm:text-base"
            >
              Solicitar Cotação
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-xl mb-6 sm:mb-8 text-gray-100">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button
                  onClick={onOpenChatbot}
                  className="bg-bradesco-red text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-primary-hover transition-colors font-semibold text-base sm:text-lg"
                >
                  Solicitar Cotação Gratuita
                </button>
                <button
                  onClick={onOpenChatbot}
                  className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-white hover:text-bradesco-blue transition-colors font-semibold text-base sm:text-lg"
                >
                  Saiba Mais
                </button>
              </div>
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-8">
                <h3 className="text-lg sm:text-2xl font-bold mb-4 sm:mb-6">Por que escolher a Bradesco Seguros?</h3>
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center">
                    <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-red-200 mr-2 sm:mr-3" />
                    <span className="text-sm sm:text-base">Uma das maiores redes de atendimento do Brasil</span>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-red-200 mr-2 sm:mr-3" />
                  ...
                  <div className="flex items-center">
                    <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-red-200 mr-2 sm:mr-3" />
                    <span className="text-sm sm:text-base">Ampla cobertura com hospitais de referência</span>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-red-200 mr-2 sm:mr-3" />
