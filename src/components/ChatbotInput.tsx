...
export default function ChatbotInput({ input, step, isTyping, inputRef, handleInputChange, handleSubmit, getInputPlaceholder }: ChatbotInputProps) {
  return (
    <form onSubmit={e => { void handleSubmit(e); }} className="p-4 bg-white border-t border-gray-200 relative">
      <input
        ref={inputRef}
        type="text"
        value={input}
